        ...
        <div class="max-w-4xl mx-auto px-2 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl rounded-lg">
                <div class="p-3 sm:p-6 bg-white">
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p class="text-sm text-boom-text-medium mt-1">
                                {{ $presupuesto->tipo_prenda }} - {{ $presupuesto->tipo_tela }}
                            </p>
                        </div>
                        <div class="flex space-x-2">
                            <a href="{{ route('presupuestos-produccion.show', $presupuesto->id) }}" 
                               class="bg-gray-600 hover:bg-gray-700 text-white font-semibold py-2 px-4 rounded-lg border-2 border-gray-800 transition-colors duration-300">
                                <i class="fas fa-eye mr-2 text-white"></i>Ver
                            </a>
                    ...
                    <form method="POST" action="{{ route('presupuestos-produccion.update', $presupuesto->id) }}" id="presupuestoForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="bg-boom-cream-50 rounded-lg p-4 mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="tipo_prenda" id="tipo_prenda" 
                                           value="{{ old('tipo_prenda', $presupuesto->tipo_prenda) }}" 
                                           list="tipos_prenda"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="tipo_tela" id="tipo_tela" 
                                           value="{{ old('tipo_tela', $presupuesto->tipo_tela) }}" 
                                           list="tipos_tela"
                                           class="w-full px-3 py-2 border border-boom-cream-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-boom-primary"
                            ...
                            <div class="mt-4">
                                ...
                                <textarea name="descripcion" id="descripcion" rows="3" 
                                          class="w-full px-3 py-2 border border-boom-cream-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-boom-primary"
                                          placeholder="Detalles adicionales del presupuesto...">{{ old('descripcion', $presupuesto->descripcion) }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="costo_tela" id="costo_tela" 
                                           value="{{ old('costo_tela', $presupuesto->costo_tela) }}" 
                                           step="0.01" min="0"
                                ...
                                <div>
                                    ...
                                    <input type="number" name="costo_cierre" id="costo_cierre" 
                                           value="{{ old('costo_cierre', $presupuesto->costo_cierre) }}" 
                                           step="0.01" min="0"
                                           class="costo-input w-full px-3 py-2 border border-boom-cream-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-boom-primary"
                                           required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="costo_boton" id="costo_boton" 
                                           value="{{ old('costo_boton', $presupuesto->costo_boton) }}" 
                                           step="0.01" min="0"
                                           class="costo-input w-full px-3 py-2 border border-boom-cream-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-boom-primary"
                                           required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="costo_bolsa" id="costo_bolsa" 
                                           value="{{ old('costo_bolsa', $presupuesto->costo_bolsa) }}" 
                                           step="0.01" min="0"
                                           class="costo-input w-full px-3 py-2 border border-boom-cream-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-boom-primary"
                                           required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="costo_hilo" id="costo_hilo" 
                                           value="{{ old('costo_hilo', $presupuesto->costo_hilo) }}" 
                                           step="0.01" min="0"
                                           class="costo-input w-full px-3 py-2 border border-boom-cream-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-boom-primary"
                                           required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="costo_etiqueta_cinta" id="costo_etiqueta_cinta" 
                                           value="{{ old('costo_etiqueta_cinta', $presupuesto->costo_etiqueta_cinta) }}" 
                                           step="0.01" min="0"
                                           class="costo-input w-full px-3 py-2 border border-boom-cream-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-boom-primary"
                                           required>
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="costo_etiqueta_carton" id="costo_etiqueta_carton" 
                                           value="{{ old('costo_etiqueta_carton', $presupuesto->costo_etiqueta_carton) }}" 
                                           step="0.01" min="0"
                                           class="costo-input w-full px-3 py-2 border border-boom-cream-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-boom-primary"
                                           required>
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="costo_tallerista" id="costo_tallerista" 
                                           value="{{ old('costo_tallerista', $presupuesto->costo_tallerista) }}" 
                                           step="0.01" min="0"
                                           class="costo-input w-full px-3 py-2 border border-boom-cream-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-boom-primary"
                                           required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="costo_planchado" id="costo_planchado" 
                                           value="{{ old('costo_planchado', $presupuesto->costo_planchado) }}" 
                                           step="0.01" min="0"
                                           class="costo-input w-full px-3 py-2 border border-boom-cream-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-boom-primary"
                                           required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="costo_ayudante" id="costo_ayudante" 
                                           value="{{ old('costo_ayudante', $presupuesto->costo_ayudante) }}" 
                                           step="0.01" min="0"
                                           class="costo-input w-full px-3 py-2 border border-boom-cream-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-boom-primary"
                                           required>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="costo_cortador" id="costo_cortador" 
                                           value="{{ old('costo_cortador', $presupuesto->costo_cortador) }}" 
                                           step="0.01" min="0"
                                           class="costo-input w-full px-3 py-2 border border-boom-cream-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-boom-primary"
                                           required>
                                </div>
                        ...
                        <div class="flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-4">
                            ...
                            <button type="submit" 
                                    class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-6 rounded-lg border-2 border-blue-800 transition-colors duration-300">
                                <i class="fas fa-save mr-2 text-white"></i>Actualizar Presupuesto
                            </button>
                        </div>
                    </form>
                </div>
